...
Across the full ocean-reanalysis-era population of 76 Gulf hurricanes — 698 fixes, 89 of them onsets — the signal weakens. The depth of warm water separates onset fixes from non-onset fixes only faintly: medians of 46 against 44 metres, a Mann–Whitney p of about 0.07, and an area under the ROC curve of 0.55, where 0.5 is no skill. The onset rate does rise across terciles of depth, from 10.0 to 13.6 to 14.7 percent, but in a cross-validated logistic model the depth of warm water adds essentially nothing once latitude, longitude, season, and current intensity are accounted for, with the area under the curve moving from 0.693 to 0.689.[^1]
